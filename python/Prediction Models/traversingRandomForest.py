...
def process_stock_csv(folder_path):
    ...
    try:
        ...
        # 3. Create lag features for basis on previous day, two days ago, and three days ago.
        ...
        metrics_file = os.path.join(folder_path, "RANDOMFOREST_metrics.txt")
        ...
        predictions_file = os.path.join(folder_path, "RANDOMFOREST_predictions.csv")
        ...
        plt.grid(True)
        plt.tight_layout()
        plot_file = os.path.join(folder_path, "RANDOMFOREST_prediction_plot.png")
...
with open("overallCompileTime_RF.txt", "w") as f:
