...
# Load the CSV
df = pd.read_csv('LSTM_all_metrics.csv')
...
def format_multicol_table(df, filename, caption='LSTM Table'):
...
# Export in-threshold as before
format_multicol_table(in_threshold, 'LSTM_inThreshold_multicol2.tex', 'LSTM Inside Threshold Table')

# Split outliers into two parts
outliers_1_40 = outliers.iloc[:40].reset_index(drop=True)
outliers_41_86 = outliers.iloc[40:].reset_index(drop=True)


# Export
format_multicol_table(in_threshold, 'LSTM_inThreshold_multicol2.tex')
format_multicol_table(outliers_1_40, 'LSTM_outliers_1_40_multicol2.tex', 'LSTM Outliers Table (1-40)')
format_multicol_table(outliers_41_86, 'LSTM_outliers_41_86_multicol2.tex', 'LSTM Outliers Table (41-86)')
