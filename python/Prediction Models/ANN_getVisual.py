...
# Load the CSV
df = pd.read_csv('ANN_all_metrics.csv')
...
def format_multicol_table(df, filename):
    ...
    with open(filename, 'w') as f:
        ...
        f.write('\\hline\n\\end{tabular}\n')
        f.write('\\caption{ANN Outside Threshold Table}\n')
        f.write('\\end{table}\n')

# Export
format_multicol_table(in_threshold, 'ANN_inThreshold_multicol2.tex')
format_multicol_table(outliers, 'ANN_outliers_multicol2.tex')
