...
# Load the CSV
df = pd.read_csv('SVR_all_metrics.csv')
...
def format_multicol_table(df, filename):
    ...
    with open(filename, 'w') as f:
        ...
        f.write('\\hline\n\\end{tabular}\n')
        f.write('\\caption{SVR Outside Threshold Table}\n')
        f.write('\\end{table}\n')

# Export
format_multicol_table(in_threshold, 'SVR_inThreshold_multicol2.tex')
format_multicol_table(outliers, 'SVR_outliers_multicol2.tex')
